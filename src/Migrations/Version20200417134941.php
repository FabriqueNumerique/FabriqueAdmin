 ...
 */
final class Version20200417134941 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE formation (id INT AUTO_INCREMENT NOT NULL, intitulé VARCHAR(255) NOT NULL, duree VARCHAR(255) NOT NULL, nombre_heure INT NOT NULL, diplome VARCHAR(255) NOT NULL, modalites VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
