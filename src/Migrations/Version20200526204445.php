 ...
 */
final class Version20200526204445 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE retard (id INT AUTO_INCREMENT NOT NULL, apprenant_id INT NOT NULL, promotion_id INT NOT NULL, date DATE NOT NULL, nombre_heure INT NOT NULL, justifie VARCHAR(255) NOT NULL, INDEX IDX_5C64DDBDC5697D6D (apprenant_id), INDEX IDX_5C64DDBD139DF194 (promotion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE absence (id INT AUTO_INCREMENT NOT NULL, apprenant_id INT DEFAULT NULL, promotion_id INT DEFAULT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, justifie VARCHAR(255) NOT NULL, INDEX IDX_765AE0C9C5697D6D (apprenant_id), INDEX IDX_765AE0C9139DF194 (promotion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE retard ADD CONSTRAINT FK_5C64DDBDC5697D6D FOREIGN KEY (apprenant_id) REFERENCES apprenant (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE retard DROP FOREIGN KEY FK_5C64DDBDC5697D6D');
        $this->addSql('ALTER TABLE promotion_apprenant DROP FOREIGN KEY FK_B59C9703C5697D6D');
        ...
        $this->addSql('ALTER TABLE promotion_apprenant DROP FOREIGN KEY FK_B59C9703139DF194');
